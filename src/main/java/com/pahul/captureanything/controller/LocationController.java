...
public class LocationController {
    ...
    public List<OldLocation> getSelectedCoordinates(@RequestParam("address") String address )
    {
        return locationService.getSelectedLocation(address);
    }

    @RequestMapping(value = "/getWeatherr",method = RequestMethod.GET, produces ="application/json")
